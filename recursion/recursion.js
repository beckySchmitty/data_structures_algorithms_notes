...
function longest(words, idx = 0, tempLongest = 0) {
  if (idx === words.length) return tempLongest;
  tempLongest = Math.max(words[idx].length, tempLongest);
  return longest(words, idx + 1, tempLongest);
}
